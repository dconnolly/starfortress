...
\usepackage[normalem]{ulem}  % for strikethrough (\sout) in diff highlighting
...
\definecolor{diffgreen}{RGB}{230, 255, 237}      % GitHub added line background
\definecolor{diffred}{RGB}{255, 235, 235}        % GitHub removed line background
\definecolor{diffgreentext}{RGB}{36, 138, 61}    % GitHub added text color (darker green)
\definecolor{diffredtext}{RGB}{207, 34, 46}      % GitHub removed text color (darker red)

% Added line (green background, like GitHub +)
\newcommand{\added}[1]{\adjustbox{cframe=diffgreen, bgcolor=diffgreen}{\strut #1}}

% Removed line (red background, like GitHub -)
\newcommand{\removed}[1]{\adjustbox{cframe=diffred, bgcolor=diffred}{\strut #1}}

% % Removed line as a full statement (no line number) - use instead of \State \removed{...}
% \newcommand{\removedline}[1]{\Statex \adjustbox{cframe=diffred, bgcolor=diffred}{\strut #1}}
