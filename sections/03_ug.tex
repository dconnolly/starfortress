...
attacks~\cite{EPRINT:GlaHovSte25}, and ensure ``binding''~\cite{CCS:CreDaxMed24} to the public data pertaining to
the computation of the hybrid shared secret. (We discuss binding in more detail in Section~\ref{sec:ug-proofs:other}.)
%
